...
class enviador_mensajes:
    ...
    def enviar_mensaje(destinatario : str, asunto : str, mensaje : str):
        """
        ...
        #Traemos los datos de las variables de entorno.
        ...
        #conficional para detener proceso en caso que no se carge info del .env
    ...
    def enviar_mensaje_con_archivo(destinatario : str, asunto : str, mensaje : str, ruta_archivo : str):
        """
